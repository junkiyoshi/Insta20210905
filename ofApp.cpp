...
void ofApp::update() {
	...
	for (int i = 0; i < this->triangle_list.size(); i++) {
		...
		this->sphere_line.addIndex(this->sphere_line.getNumVertices() - 1); this->sphere_line.addIndex(this->sphere_line.getNumVertices() - 2);
		this->sphere_line.addIndex(this->sphere_line.getNumVertices() - 2); this->sphere_line.addIndex(this->sphere_line.getNumVertices() - 3);
		this->sphere_line.addIndex(this->sphere_line.getNumVertices() - 1); this->sphere_line.addIndex(this->sphere_line.getNumVertices() - 3);
	}
}
